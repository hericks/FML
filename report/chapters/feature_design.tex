...
Als ein effizienter Algorithmus da war, der den kürzesten Pfad berechnen konnte, ging es anschließend darum nur den kürzesten Pfad zu den Objekten einer Klasse zu berechnen, die auch wirklich nah waren. Gegeben der Liste von Positionen aller crates, wollte man sich nur die relativ nahen crates 
